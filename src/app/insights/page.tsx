...
const categories = ["All", "Health Insurance", "Term Insurance", "Risk Planning", "Decision Making", "Life Planning"];
    ...
    <>
        ...
        <div className="section-container">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-xl text-slate-500 leading-relaxed text-balance">
              Practical guides to help you understand coverage, evaluate options,
              and make decisions you're confident about — written by an advisor
              who is also a software engineer.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-py bg-slate-50">
        <div className="section-container">
          {/* Featured article */}
          <div className="mb-10">
            <h2 className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-5">Featured</h2>
            <InsightCard {...insights[0]} variant="featured" />
          </div>

          {/* All articles */}
          <div>
            <h2 className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-5">All Insights</h2>
      ...
      <section className="section-py bg-white">
        <div className="section-container">
          <div className="max-w-2xl mx-auto text-center rounded-3xl border border-slate-100 bg-slate-50 p-10">
            <Badge variant="blue" className="mb-4">Stay Informed</Badge>
            <h2 className="text-2xl font-bold text-slate-900 mb-3 text-balance">
              New insights, when they matter
            </h2>
            <p className="text-slate-500 text-sm leading-relaxed mb-8">
              We publish infrequently and only when there's something genuinely useful to say.
              No newsletters. No promotional content. Just education.
            </p>
            <a
              href="https://wa.me/919999999999?text=Please%20notify%20me%20when%20new%20insights%20are%20published"
              target="_blank"
